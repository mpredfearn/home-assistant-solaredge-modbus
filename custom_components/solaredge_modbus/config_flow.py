...
DATA_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_INVERTER1_ID, default=DEFAULT_INVERTER1_ID): int,
        vol.Optional(CONF_INVERTER2_ID, default=DEFAULT_INVERTER2_ID): int,
        vol.Optional(CONF_INVERTER3_ID, default=DEFAULT_INVERTER3_ID): int,
